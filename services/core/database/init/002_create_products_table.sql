...
-- Foreign keys opsional (karena microservice terpisah, bisa di-skip)
-- ALTER TABLE products ADD CONSTRAINT fk_products_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;
-- ALTER TABLE products ADD CONSTRAINT fk_products_file FOREIGN KEY (file_id) REFERENCES files(id) ON DELETE CASCADE;
