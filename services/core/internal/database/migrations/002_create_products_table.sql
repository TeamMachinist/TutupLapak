...
CREATE INDEX IF NOT EXISTS idx_products_name_search ON products(name) WHERE name IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_products_search ON products(category, name, price);
