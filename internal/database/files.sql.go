...
func (q *Queries) GetFileByIDAndUserID(ctx context.Context, arg GetFileByIDAndUserIDParams) (Files, error) {
	row := q.db.QueryRow(ctx, getFileByIDAndUserID, arg.ID, arg.UserID)
	var i Files
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
func (q *Queries) GetFilesByUser(ctx context.Context, userID uuid.UUID) ([]Files, error) {
